...
class CalculationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Calculate = channel.unary_unary(
                ...
                request_serializer=hub__pb2.Command.SerializeToString,
                response_deserializer=hub__pb2.Command.FromString,
...
def add_CalculationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Calculate': grpc.unary_unary_rpc_method_handler(
                    servicer.Calculate,
                    request_deserializer=hub__pb2.Command.FromString,
                    response_serializer=hub__pb2.Command.SerializeToString,
            ),
    }
...
class CalculationService(object):
    ...
    def Calculate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/CalculationService/Calculate',
            hub__pb2.Command.SerializeToString,
            hub__pb2.Command.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
